...
export declare function replaceKeys(obj: Record<string, any>): Record<string, any>;
export declare function getEntries<Item>(obj: ArrayLike<Item> | Record<string, Item>, options: GlobalContext): [string, Item][];
export {};
