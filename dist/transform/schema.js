import { prepareComment, nodeType, tsArrayOf, tsIntersectionOf, tsReadonly, tsTupleOf, tsUnionOf, parseSingleSimpleValue, getEntries, } from "../utils.js";
const EOF_RE = /\n+$/;
...
export function transformAnyOf(anyOf, options) {
    ...
    return tsUnionOf(schemas.map((s) => transformSchemaObj(s, options)));
}
